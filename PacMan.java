...
public class PacMan extends Person
{
    ...
    public void act() 
    {
        ...
        {
            getWorld().showText("Puntuacion: ",300,10);
    ...
    void checkItems(){
        ...
        getWorld().showText(String.valueOf(points),390,10);
        if(isTouching(SmallPoint.class)){
            removeTouching(SmallPoint.class);
            points+= 10;
        } else if(isTouching(PowerPoint.class)){
            removeTouching(PowerPoint.class);
            points+= 30;
        }
    }
    ...
    void checkPhantom(){
        if(isTouching(Phantom.class)){
                getWorld().showText("FIN DEL JUEGO",400,400);
                Greenfoot.stop();
            }
    }
}
